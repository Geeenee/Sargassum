 ...
 <footer class="py-8 bg-cyan-700">
    <div>
      <div class="flex flex-col justify-between w-10/12 mx-auto gap-9 md:flex-row">
        <!-- GO DENTAL / Div1 -->
        <div class="text-gray-200 intro-x md:w-72">
            <p class="mb-4 text-lg font-medium md:text-center">Sargassum Biotech Inc</p>
            <img alt="logo" src="" class="w-24 bg-white">
        </div>
        <!-- Contact Us / Div2 -->
        <div class="text-gray-200 intro-x md:w-48">
            <h4 class="mb-2 text-lg font-semibold text-gray-200">Customer Care</h4>
              <ul>
                    <li>
                        <a href="" class="relative inline-block mb-2 text-base leading-loose text-body-color group">
                            <span>FAQ</span>
                            <span class="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-slate-100 transition-all group-hover:w-full"></span>
                        </a>
                    </li>
                    <a href="" class="text-lg font-semibold">Contact Us</a>
                    <li>
